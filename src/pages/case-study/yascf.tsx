	...
	return (
		<main className="p-main">
			...
			<CaseStudyVideoHeader
				...
				poster="/images/casestudy/yascf-1.png"
			/>
			...
			{/* THE BRIEF */}
			{/* YT  not available */}
			<OneImgCrd assetType="video" assetLink="/video/yascf-2.webm" />
			...
			<OneImgCrd assetType="image" assetLink="/images/casestudy/yascf-3.png" />
