...
function VideoProduction() {
  ...
  const SCROLL_ITEMS: Item[] = [
    { backgroundLink: "/images/13.jpg", text: "Customer Testimonials" },
    { backgroundLink: "/images/110.jpg", text: "Social Media Videos" },
    { backgroundLink: "/images/17.jpg", text: "Documentaries" },
    { backgroundLink: "/images/111.jpg", text: "Brand Marketing Videos" },
    { backgroundLink: "/images/15.jpg", text: "Product Videos" },
    { backgroundLink: "/images/18.jpg", text: "Short Films" },
    { backgroundLink: "/images/14.jpg", text: "TV Commercials" },
    { backgroundLink: "/images/13.jpg", text: "Event Highlights" },
    { backgroundLink: "/images/110.jpg", text: "NGO Stories" },
    { backgroundLink: "/images/17.jpg", text: "Behind-the-Scenes Films" },
    { backgroundLink: "/images/13.jpg", text: "Customer Testimonials" },
    { backgroundLink: "/images/110.jpg", text: "Social Media Videos" },
    { backgroundLink: "/images/17.jpg", text: "Documentaries" },
    { backgroundLink: "/images/111.jpg", text: "Brand Marketing Videos" },
