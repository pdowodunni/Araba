...
function ShowcaseCardVertical({
  ...
  return (
    <div className="group grid w-[328px] h-[525px] xl:w-[390px] xl:h-[588px] 2xl:h-[760px] 2xl:w-[525px] grid-rows-[1fr_150px] overflow-hidden rounded-lg transition-all duration-300 hover:grid-rows-[1fr_200px]">
