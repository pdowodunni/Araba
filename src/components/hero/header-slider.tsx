...
function HeaderSlider() {
  ...
  */
  ...
  return (
    <div>
      <div className="flex gap-4 max-h-[965px] opacity-0" ref={containerRef}>
        <VerticalCarouselUp ImageList={VERTICAL_CAROUSEL_ONE} speed={0.015} />
        <VerticalCarouselDown />
        <VerticalCarouselUp ImageList={VERTICAL_CAROUSEL_TWO} speed={0.01} />
      </div>
    </div>
  );
}
